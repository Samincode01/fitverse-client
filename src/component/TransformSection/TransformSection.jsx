      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid lg:grid-cols-2 gap-20 items-center">
          ...
          >
            ...
            <div className="relative rounded-[35px] overflow-hidden border border-white/10 shadow-[0_20px_60px_rgba(0,0,0,.5)]">
              <Image
          ...
          >
            ...
            <div className="inline-flex items-center gap-2 px-5 py-2 rounded-full border border-white/10 bg-white/[0.04] backdrop-blur-xl mb-7">
            ...
            <div className="flex gap-5 mt-12">
              <div className="w-14 h-14 rounded-full bg-[#D9FF3F] text-black flex items-center justify-center">
                <Dumbbell />
              </div>
            ...
            <div className="flex items-center gap-8 mt-14">
              <button className="group px-8 py-5 rounded-full bg-[#D9FF3F] text-black font-semibold flex items-center gap-3 transition-all duration-300 hover:scale-105">
                Get In Touch
              ...
              <div className="flex items-center gap-4">
                <div className="w-14 h-14 rounded-full bg-white/5 border border-white/10 text-[#D9FF3F] flex items-center justify-center">
                  <PhoneCall />
                </div>
