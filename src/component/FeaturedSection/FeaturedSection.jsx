        ...
        <div className="flex flex-col md:flex-row items-center justify-between mb-16">
          ...
          <div>
            ...
            <h2 className="text-5xl font-bold text-white">
              Featured <span className="text-[#D9FF3F]">Classes</span>
            </h2>
          ...
          <Link href="/classes" className="mt-8 md:mt-0 px-8 py-4 rounded-full bg-[#D9FF3F] text-black font-bold transition-all duration-300 hover:scale-105 hover:bg-[#c9ef39]">
            View More
          </Link>
